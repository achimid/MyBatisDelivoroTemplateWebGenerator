...
public class DelivoroCRUDTemplate {
    ...
    protected StringBuilder tSqlWhere =
        new StringBuilder()
            ...
            .append(TABULACAO)
                .append(TABULACAO)
                    .append(TABULACAO)
                        .append("<isNotEmpty property=\"idPainelSenhasMonitor\" prepend=\"AND\">")
                        .append(QUEBRA_LINHA)
            .append(TABULACAO)
                .append(TABULACAO)
                    .append(TABULACAO)
                        .append(TABULACAO)
                            .append("id_painel_senhas_monitor = #idPainelSenhasMonitor#")
                            .append(QUEBRA_LINHA)
            .append(TABULACAO)
                .append(TABULACAO)
                    .append(TABULACAO)
    ...
    protected StringBuilder tInsert =
        new StringBuilder()
            ...
            .append(TABULACAO)
                .append(TABULACAO)
                    .append("<selectKey keyProperty=\"idPainelSenhasMonitor\" type=\"post\" resultClass=\"int\">")
                    .append(QUEBRA_LINHA)
            .append(TABULACAO)
                .append(TABULACAO)
                    .append(TABULACAO)
                        .append("SELECT last_insert_id() AS idPainelSenhasMonitor")
                        .append(QUEBRA_LINHA)
            .append(TABULACAO)
                .append(TABULACAO)
                    .append("</selectKey>")
